  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1><b class="uppercase">Cập nhật mật khẩu</b></h1>
      </div>
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div>
              <h6><b class="uppercase">Cập nhật mật khẩu</b></h6>
            </div>
            ...
            <div class="form-group">
               <input type="submit" value="Cập nhật" name="update" id="submit" class="btn btn-block">
            </div>
          </form>
        </div>
      </div>
