      ...
      <div class="container-fluid">
        <div class="page-header_wrap">
          <div class="page-heading">
            <h1><B>PHẢN HỒI CỦA TÔI</B></h1>
          </div>
          <ul class="coustom-breadcrumb">
            <li><a href="#">Trang chủ</a></li>
            <li>Phản hồi của tôi</li>
          </ul>
        </div>
      </div>
      <!-- Dark Overlay-->
          ...
          <div class="container">
            ...
            <div class="container">
              ...
              <div class="profile_wrap">
                <h5 class="uppercase underline"><b>Phản hồi của tôi</b> </h5>
                      ...
                      foreach ($results as $result) { ?>
                        ...
                        <li>
                          ...
                          <?php if ($result->status == 1) { ?>
                            <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">Đã duyệt phản hồi</a>
                            <p>Cảm ơn quý khách đã phản hồi dịch vụ. <br> Chúng tôi sẽ cải thiện dịch vụ tốt hơn.</p>

                              <div class="clearfix"></div>
                            </div>
                          <?php } else { ?>
                            <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Đang chờ duyệt</a>
                              <div class="clearfix"></div>
                            </div>
                          <?php } ?>
                        </li>
