                ...
                <div class="user_profile_info gray-bg " style="width: 600px;">
                  ...
                  <div class="container">
                    <div class="profile_wrap">
                      ...
                      <?php
                      if ($msg) { ?><div class="succWrap"><strong>Thành công</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
                      <form method="post">
                        <div class="form-group">
                          <label class="control-label">Ngày đăng ký: &ensp;</label>
                          <?php echo htmlentities($result->RegDate); ?>
                        </div>
                        <?php if ($result->UpdationDate != "") { ?>
                          <div class="form-group">
                            <label class="control-label">Cập nhật lần cuối: &ensp;</label>
                    ...
                    <div class="form-group ">
                      <button type="submit" name="updateprofile" class="btn btn-block"><b>CẬP NHẬT</b><span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                    </div>
                      </form>
                    </div>
