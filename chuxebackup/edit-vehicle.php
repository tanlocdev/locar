...
?>
	...
	<head>
		...
		<title>Locars | Admin Cập nhật thông tin xe</title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title text-center">CẬP NHẬT THÔNG TIN XE</h2>
							<button class="fa fa-arrow-left" onclick="goBack()"> Trở về </button> <p>
												...
												foreach ($results as $result) {	?>
													...
													<form method="post" class="form-horizontal" enctype="multipart/form-data">
														<div class="form-group">
															...
															<label class="col-sm-2 control-label">Chọn hãng xe<span style="color:red">*</span></label>
															<div class="col-sm-4">
														...
														<div class="form-group">
															<label class="col-sm-2 control-label">Mô tả chi tiết<span style="color:red">*</span></label>
															<div class="col-sm-10">
														...
														<div class="form-group">
															<label class="col-sm-2 control-label">Giá thuê (VND)<span style="color:red">*</span></label>
															<div class="col-sm-4">
														...
														<div class="form-group">
															<div class="col-sm-4">
																Hình ảnh 1 <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage1); ?>" width="300" height="200" style="border:solid 1px #000">
																<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id) ?>">Thay đổi 1</a>
															</div>
															<div class="col-sm-4">
																Hình ảnh 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2); ?>" width="300" height="200" style="border:solid 1px #000">
																<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id) ?>">Thay đổi 2</a>
															</div>
															<div class="col-sm-4">
																Hình ảnh 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3); ?>" width="300" height="200" style="border:solid 1px #000">
																<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id) ?>">Thay đổi 3</a>
															</div>
														</div>
														...
														<div class="form-group">
															<div class="col-sm-4">
																Hình ảnh 4<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage4); ?>" width="300" height="200" style="border:solid 1px #000">
																<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id) ?>">Thay đổi 4</a>
															</div>
															<div class="col-sm-4">
																Hình ảnh 5
																<?php if ($result->Vimage5 == "") {
																	echo htmlentities(": Không có ảnh");
																} else { ?>
																	<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage5); ?>" width="300" height="200" style="border:solid 1px #000">
																	<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id) ?>">Thay đổi 5</a>
																<?php } ?>
															</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-primary">
										<div class="panel-heading">TRANG BỊ</div>
										<div class="panel-body">
												...
												<div class="col-sm-3">
													<?php if ($result->AirConditioner == 1) { ?>
														<div class="checkbox checkbox-inline">
															...
															<label for="inlineCheckbox1"> Điều hòa tự động </label>
														</div>
													<?php } else { ?>
														<div class="checkbox checkbox-inline">
												...
												<div class="col-sm-3">
													<?php if ($result->PowerDoorLocks == 1) { ?>
														<div class="checkbox checkbox-inline">
															...
															<label for="inlineCheckbox2"> Khóa cửa tự động </label>
														</div>
													<?php } else { ?>
												...
												<div class="col-sm-3">
													<?php if ($result->AntiLockBrakingSystem == 1) { ?>
														<div class="checkbox checkbox-inline">
															...
															<label for="inlineCheckbox3"> Chống bó cứng phanh ABS </label>
														</div>
													<?php } else { ?>
														<div class="checkbox checkbox-inline">
												...
												<div class="col-sm-3">
													...
													?>
														<div class="checkbox checkbox-inline">
															...
															<label for="inlineCheckbox3"> Phân phối lực phanh EBD </label>
														</div>
													<?php } else { ?>
														<div class="checkbox checkbox-inline">
													...
													?>
														<div class="col-sm-3">
															<div class="checkbox checkbox-inline">
																...
																<label for="inlineCheckbox1"> Trợ lực lái </label>
															</div>
														<?php } else { ?>
															<div class="col-sm-3">
																<div class="checkbox checkbox-inline">
															...
															?>
																<div class="col-sm-3">
																	...
																	<div class="checkbox checkbox-inline">
																		...
																		<label for="inlineCheckbox2">Túi khí hàng ghế trước</label>
																	</div>
																<?php } else { ?>
																	<div class="checkbox checkbox-inline">
																	...
																	<div class="col-sm-3">
																		...
																		?>
																			<div class="checkbox checkbox-inline">
																				...
																				<label for="inlineCheckbox3"> Túi khí hàng ghế sau </label>
																			</div>
																		<?php } else { ?>
																			<div class="checkbox checkbox-inline">
																	...
																	<div class="col-sm-3">
																		...
																		?>
																			<div class="checkbox checkbox-inline">
																				...
																				<label for="inlineCheckbox3"> Kính 2 lớp </label>
																			</div>
																		<?php } else { ?>
																			<div class="checkbox checkbox-inline">
																		...
																		<div class="col-sm-3">
																			...
																			?>
																				<div class="checkbox checkbox-inline">
																					...
																					<label for="inlineCheckbox1"> Màn hình cảm ứng </label>
																				</div>
																			<?php } else { ?>
																				<div class="checkbox checkbox-inline">
																		...
																		<div class="col-sm-3">
																			...
																			?>
																				<div class="checkbox  checkbox-inline">
																					...
																					<label for="inlineCheckbox2">Khóa Vi sai trung tâm</label>
																				</div>
																			<?php } else { ?>
																				<div class="checkbox checkbox-success checkbox-inline">
																		...
																		<div class="col-sm-3">
																			...
																			?>
																				<div class="checkbox checkbox-inline">
																					...
																					<label for="inlineCheckbox3"> Cảnh báo điểm mù </label>
																				</div>
																			<?php } else { ?>
																				<div class="checkbox checkbox-inline">
																		...
																		<div class="col-sm-3">
																			...
																			?>
																				<div class="checkbox checkbox-inline">
																					...
																					<label for="inlineCheckbox3"> Ghế da </label>
																				</div>
																			<?php } else { ?>
																				<div class="checkbox checkbox-inline">
															...
															<div class="form-group">
																<div class="col-sm-8 col-sm-offset-2 text-center">
																	...
																	<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">&ensp; LƯU THAY ĐỔI &ensp;</button>
																</div>
															</div>
