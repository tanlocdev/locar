...
<head>
	...
	<title>Locars - Admin quản lý liên hệ </title>
...
<body>
	...
	<div class="ts-main-content">
		<?php $page = 'manage-conactusquery'; include('includes/leftbar.php');?>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title text-center">QUẢN LÝ THÔNG TIN LIÊN HỆ NGƯỜI DÙNG</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-primary">
							<div class="panel-heading">Thông tin người dùng liên hệ</div>
