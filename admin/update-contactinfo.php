			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title text-center">CẬP NHẬT THÔNG TIN LIÊN HỆ</h2>
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button style="width: 300px;" class="btn btn-primary form-control text-center" name="submit" type="submit"><b>Cập nhật</b></button>
												</div>
											</div>
