												...
												foreach ($results as $result) {				?>
													<tr>
														...
														<td><a href="edit-vehicle.php?id=<?php echo $result->id; ?>"><i class="fa fa-edit fa-2x"></i></a>&ensp;&ensp;&ensp;&ensp;
															<a href="manage-vehicles.php?del=<?php echo $result->id; ?>" onclick="return confirm('Bạn thật sự muốn XÓA xe này!');"><i class="fa fa-close fa-2x" style="color: red;"></i></a>
														</td>
													</tr>
											<?php $cnt = $cnt + 1;
												}
