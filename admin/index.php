...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/mazda6.jpg);">
		<div class="form-content">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">ADMIN</h1>
						<div class="well row pt-2x pb-3x bk-light">
						<h1 class="text-center text-bold mt-2x">ĐĂNG NHẬP</h1>
							<div class="col-md-8 col-md-offset-2">
								<form method="post">

									<label for="" class="text-uppercase text-sm">Tên tài khoản </label>
									<input type="text" placeholder="Tên tài khoản" name="username" class="form-control mb">
