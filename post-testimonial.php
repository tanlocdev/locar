  ...
  <div class="container-fluid">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1><b class="uppercase">Gửi phản hồi</b></h1>
      </div>
  ...
  <div class="container">
      ...
      <div class="container">
        <div class="profile_wrap">
          <h5 class="uppercase underline"><b>Gửi phản hồi</b></h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <button type="submit" name="submit" class="btn btn-block">Gửi  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
