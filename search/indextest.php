...
<body>
  ...
  <section id="listing_img_slider" style="width:90%;" class="container">
    <div><img src="../admin/img/vehicleimages/camry.jpg" class="img-responsive" alt="image" width="900" height="700"></div>
    <div><img src="../admin/img/vehicleimages/camry.jpg" class="img-responsive" alt="image" width="900" height="700"></div>
    <div><img src="../admin/img/vehicleimages/camry.jpg" class="img-responsive" alt="image" width="900" height="700"></div>
    <div><img src="../admin/img/vehicleimages/camry.jpg" class="img-responsive" alt="image" width="900" height="700"></div>
    ...
    <div class="container">
      ...
      <div class="container">
        ...
        <div class="input-group">
          ...
          <input style="border: solid 1px; border-top-right-radius:50px; border-bottom-right-radius: 50px; " type="text" name="search_text" id="search_text" placeholder="Nhập tên xe, hãng xe, giá, hoặc mô tả của xe..." class="form-control" />
