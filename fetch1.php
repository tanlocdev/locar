		...
		$output .= '
              ...
              <div class="col-list-3">
					<div class="recent-car-list">
						<div class="car-info-box"> <a href="vehical-details.php?vhid=' . $row["id"] . '"><img  style="height:230px; width:auto;" src="admin/img/vehicleimages/' . $row["Vimage1"] . '" class="img-responsive" alt="image"></a>
						<ul>
